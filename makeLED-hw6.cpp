...
//// Start of HW6 part2 commmands 
//// program shall accept two new commands blink and int n. 
//// Blink USR3 LED n times (ON and OFF).
//// USR3 stays on for 1sec and off for 1sec.
//// Blink LED (with out using commands given in the HW).
//
   else if (cmd =="blink" )
	{
	int n = atoi(argv[2]);
	       ...
	       writeLED("/brightness", "0");
	       sleep(1);		
       	       cout << "USR3 Blinked LED: " << i+1 << "times" << endl;
